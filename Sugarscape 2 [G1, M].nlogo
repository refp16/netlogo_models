...
WHAT IS IT?
-----------
This model implements Epstein & Axtell's Sugarscape model under rules ({G1},{M}) as described in chapter 2 of their book Growing Artificial Societies: Social Science from the Bottom Up. It simulates a population with limited, spatially-distributed resources available.
...
- Li, J. and Wilensky, U. (2009).  NetLogo Sugarscape 2 Constant Growback.  http://ccl.northwestern.edu/netlogo/models/Sugarscape2ConstantGrowback.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.   
